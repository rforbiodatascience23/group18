...
The 'Model Coefficents' bar plot shows the estimate found in step 3 of all variables. When presenting these estimates, it's common to include the 'intercept' but to focus your interpretation and discussion on the estimates of the predictor variables, as they provide more actionable insights into how the predictors impact the outcome.
